!(function (e, t) {
    ...
    function E(e, t, n) {
        var r = t.href,
            ...
            s = e[1].replace(/\\([\[\]])/g, "$1");
        return "!" !== e[0].charAt(0) ? { type: "link", raw: n, href: r, title: i, text: s } : { type: "image", raw: n, href: r, title: i, text: U(s) };
    }
    var D = (function () {
            function e(e) {
                this.options = e || q;
            ...
            return (
                (t.space = function (e) {
                    ...
                    if (t) return 1 < t[0].length ? { type: "space", raw: t[0] } : { raw: "\n" };
                }),
                (t.code = function (e, t) {
                    ...
                    if (n) {
                        ...
                        return { type: "code", raw: n[0], codeBlockStyle: "indented", text: this.options.pedantic ? i : O(i, "\n") };
                    }
                }),
                (t.fences = function (e) {
                ...
                (t.nptable = function (e) {
                    ...
                    if (t) {
                        var n = { type: "table", header: C(t[1].replace(/^ *| *\| *$/g, "")), align: t[2].replace(/^ *|\| *$/g, "").split(/ *\| */), cells: t[3] ? t[3].replace(/\n$/, "").split("\n") : [], raw: t[0] };
                        if (n.header.length === n.align.length) {
                            ...
                            for (r = n.cells.length, i = 0; i < r; i++) n.cells[i] = C(n.cells[i], n.header.length);
                            return n;
                        }
                    }
                }),
                    ...
                    if (t) {
                        for (
                            var n,
                                ...
                                p = 1 < u.length,
                                h = ")" === u[u.length - 1],
                                g = { type: "list", raw: c, ordered: p, start: p ? +u.slice(0, -1) : "", loose: !1, items: [] },
                            ...
                            (r = (c = n = f[b]).length),
                                ...
                                b !== k - 1 &&
                                    ...
                                    (p ? 1 === i.length || (!h && ")" === i[i.length - 1]) : 1 < i.length || (this.options.smartLists && i !== u)) &&
                                        ((s = f.slice(b + 1).join("\n")), (g.raw = g.raw.substring(0, g.raw.length - s.length)), (b = k - 1))),
                                (l = d || /\n\n(?!\s*$)/.test(n)),
                                b !== k - 1 && ((d = "\n" === n.charAt(n.length - 1)), (l = l || d)),
                                l && (g.loose = !0),
                                (o = void 0),
                                (a = /^\[[ xX]\] /.test(n)) && ((o = " " !== n[1]), (n = n.replace(/^\[[ xX]\] +/, ""))),
                                g.items.push({ type: "list_item", raw: c, task: a, checked: o, loose: l, text: n });
                        return g;
                    }
                }),
                (t.html = function (e) {
                ...
                (t.def = function (e) {
                    ...
                    if (t) return t[3] && (t[3] = t[3].substring(1, t[3].length - 1)), { tag: t[1].toLowerCase().replace(/\s+/g, " "), raw: t[0], href: t[2], title: t[3] };
                }),
                (t.table = function (e) {
                    ...
                    if (t) {
                        ...
                        if (n.header.length === n.align.length) {
                            ...
                            for (var r = n.align.length, i = 0; i < r; i++)
                                /^ *-+: *$/.test(n.align[i]) ? (n.align[i] = "right") : /^ *:-+: *$/.test(n.align[i]) ? (n.align[i] = "center") : /^ *:-+ *$/.test(n.align[i]) ? (n.align[i] = "left") : (n.align[i] = null);
                            for (r = n.cells.length, i = 0; i < r; i++) n.cells[i] = C(n.cells[i].replace(/^ *\| *| *\| *$/g, ""), n.header.length);
                            return n;
                        }
                    }
                }),
                ...
                (t.tag = function (e, t, n) {
                    ...
                    if (r)
                        return (
                            ...
                            { type: this.options.sanitize ? "text" : "html", raw: r[0], inLink: t, inRawBlock: n, text: this.options.sanitize ? (this.options.sanitizer ? this.options.sanitizer(r[0]) : U(r[0])) : r[0] }
                        );
                }),
                (t.link = function (e) {
                    ...
                    if (t) {
                        var n,
                            r = j(t[2], "()");
                        -1 < r && ((n = (0 === t[0].indexOf("!") ? 5 : 4) + t[1].length + r), (t[2] = t[2].substring(0, r)), (t[0] = t[0].substring(0, n).trim()), (t[3] = ""));
                        var i,
                            s = t[2],
                            l = "";
                        return (
                            (l = this.options.pedantic ? ((i = /^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(s)), i ? ((s = i[1]), i[3]) : "") : t[3] ? t[3].slice(1, -1) : ""),
                            E(t, { href: (s = s.trim().replace(/^<([\s\S]*)>$/, "$1")) ? s.replace(this.rules.inline._escapes, "$1") : s, title: l ? l.replace(this.rules.inline._escapes, "$1") : l }, t[0])
                        );
                    }
                }),
                (t.reflink = function (e, t) {
                    ...
                    if ((n = this.rules.inline.reflink.exec(e)) || (n = this.rules.inline.nolink.exec(e))) {
                        ...
                        if ((r = t[r.toLowerCase()]) && r.href) return E(n, r, n[0]);
                        var i = n[0].charAt(0);
                ...
                (t.codespan = function (e) {
                    ...
                    if (t) {
                        ...
                        return r && i && (n = n.substring(1, n.length - 1)), (n = U(n, !0)), { type: "codespan", raw: t[0], text: n };
                    }
                }),
                (t.br = function (e) {
                ...
                (t.autolink = function (e, t) {
                    ...
                    if (n) {
                        var r,
                            i = "@" === n[2] ? "mailto:" + (r = U(this.options.mangle ? t(n[1]) : n[1])) : (r = U(n[1]));
                ...
                (t.inlineText = function (e, t, n) {
                    ...
                    if (r) {
                        var i = t ? (this.options.sanitize ? (this.options.sanitizer ? this.options.sanitizer(r[0]) : U(r[0])) : r[0]) : U(this.options.smartypants ? n(r[0]) : r[0]);
    ...
    (B.def = L(B.def).replace("label", B._label).replace("title", B._title).getRegex()),
        (B.bullet = /(?:[*+-]|\d{1,9}[.)])/),
        (B.item = /^( *)(bull) ?[^\n]*(?:\n(?!\1bull ?)[^\n]*)*/),
        ...
        (B.paragraph = L(B._paragraph)
            ...
            .replace("tag", B._tag)
            .getRegex()),
        (B.blockquote = L(B.blockquote).replace("paragraph", B.paragraph).getRegex()),
        (B.normal = N({}, B)),
        (B.gfm = N({}, B.normal, {
    ...
    (F.punctuation = L(F.punctuation)
        ...
        (F._comment = L(B._comment).replace("(?:--\x3e|$)", "--\x3e").getRegex()),
        ...
        (F.autolink = L(F.autolink).replace("scheme", F._scheme).replace("email", F._email).getRegex()),
        (F._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
        (F.tag = L(F.tag).replace("comment", F._comment).replace("attribute", F._attribute).getRegex()),
        (F._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/),
        (F._href = /<(?:\\[<>]?|[^\s<>\\])*>|[^\s\x00-\x1f]*/),
        (F._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
        (F.link = L(F.link).replace("label", F._label).replace("href", F._href).replace("title", F._title).getRegex()),
        (F.reflink = L(F.reflink).replace("label", F._label).getRegex()),
        (F.reflinkSearch = L(F.reflinkSearch, "g").replace("reflink", F.reflink).replace("nolink", F.nolink).getRegex()),
        (F.normal = N({}, F)),
        ...
        (F.gfm.url = L(F.gfm.url, "i").replace("email", F.gfm._extended_email).getRegex()),
        (F.breaks = N({}, F.gfm, {
    ...
    var K = (function () {
            function n(e) {
                ...
                this.options.pedantic ? ((t.block = X.pedantic), (t.inline = G.pedantic)) : this.options.gfm && ((t.block = X.gfm), this.options.breaks ? (t.inline = G.breaks) : (t.inline = G.gfm)), (this.tokenizer.rules = t);
            }
            (n.lex = function (e, t) {
                    ...
                    if (this.tokens.links) {
                        ...
                        if (0 < o.length)
                            for (; null != (l = this.tokenizer.rules.inline.reflinkSearch.exec(a)); )
                                o.includes(l[0].slice(l[0].lastIndexOf("[") + 1, -1)) && (a = a.slice(0, l.index) + "[" + V("a", l[0].length - 2) + "]" + a.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex));
                    }
                    for (; null != (l = this.tokenizer.rules.inline.blockSkip.exec(a)); ) a = a.slice(0, l.index) + "[" + V("a", l[0].length - 2) + "]" + a.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);
                    for (; e; )
                        ...
                        else if ((s = this.tokenizer.autolink(e, J))) (e = e.substring(s.raw.length)), t.push(s);
                        else if (n || !(s = this.tokenizer.url(e, J))) {
                            if ((s = this.tokenizer.inlineText(e, r, H))) (e = e.substring(s.raw.length)), (i = s.raw.slice(-1)), t.push(s);
                            else if (e) {
            ...
            return (
                (t.code = function (e, t, n) {
                    var r,
                        i = (t || "").match(/\S*/)[0];
                    return (
                        !this.options.highlight || (null != (r = this.options.highlight(e, i)) && r !== e && ((n = !0), (e = r))),
        ...
        le = (function () {
            ...
            return (
                (e.parse = function (e, t) {
                    void 0 === t && (t = !0);
                    for (var n, r, i, s, l, a, o, c, u, p, h, g, f, d, k, b, m, x = "", v = e.length, w = 0; w < v; w++)
                        switch ((u = e[w]).type) {
                            case "space":
                                continue;
                            case "hr":
                                ...
                                continue;
                            case "heading":
                                x += this.renderer.heading(this.parseInline(u.tokens), u.depth, se(this.parseInline(u.tokens, this.textRenderer)), this.slugger);
                                continue;
                            case "code":
                            ...
                            case "blockquote":
                                ...
                                continue;
                            case "list":
                                for (p = u.ordered, h = u.start, g = u.loose, i = u.items.length, c = "", n = 0; n < i; n++)
                                            ...
                                            g
                                                ? 0 < d.tokens.length && "text" === d.tokens[0].type
                                                    ? ((d.tokens[0].text = m + " " + d.tokens[0].text),
                                                      d.tokens[0].tokens && 0 < d.tokens[0].tokens.length && "text" === d.tokens[0].tokens[0].type && (d.tokens[0].tokens[0].text = m + " " + d.tokens[0].tokens[0].text))
    ...
    function ge(e, n, r) {
        ...
        if (("function" == typeof n && ((r = n), (n = null)), (n = ae({}, ge.defaults, n || {})), oe(n), r)) {
            var i,
                s = n.highlight;
            try {
                i = K.lex(e, n);
            ...
            var a = 0;
            return (
                ge.walkTokens(i, function (n) {
                    "code" === n.type &&
                        (a++,
                        setTimeout(function () {
                            s(n.text, n.lang, function (e, t) {
                                if (e) return l(e);
                                null != t && t !== n.text && ((n.text = t), (n.escaped = !0)), 0 === --a && l();
                            });
                        }, 0));
                }),
                void (0 === a && l())
        ...
        try {
            var t = K.lex(e, n);
            return n.walkTokens && ge.walkTokens(t, n.walkTokens), le.parse(t, n);
        } catch (e) {
    ...
    return (
        (ge.options = ge.setOptions = function (e) {
            return ae(ge.defaults, e), pe(ge.defaults), ge;
        }),
        (ge.getDefaults = ue),
        (ge.defaults = he),
        (ge.use = function (a) {
            ...
            a.renderer &&
                (function () {
                    ...
                    var l = ge.defaults.renderer || new te();
                    for (var t in a.renderer) e(t);
                    n.renderer = l;
                })(),
                a.tokenizer &&
                    (function () {
                        ...
                        var l = ge.defaults.tokenizer || new D();
                        for (var t in a.tokenizer) e(t);
                        n.tokenizer = l;
                    })(),
                a.walkTokens &&
                    ((t = ge.defaults.walkTokens),
            ...
            for (var n, r = g(e); !(n = r()).done; ) {
                ...
                switch ((t(i), i.type)) {
                    case "table":
                        ...
                        break;
                    case "list":
                        ge.walkTokens(i.items, t);
                        break;
                    default:
                        i.tokens && ge.walkTokens(i.tokens, t);
                }
            }
        }),
        (ge.parseInline = function (e, t) {
            ...
            (t = ae({}, ge.defaults, t || {})), oe(t);
            try {
                var n = K.lexInline(e, t);
                return t.walkTokens && ge.walkTokens(n, t.walkTokens), le.parseInline(n, t);
            } catch (e) {
